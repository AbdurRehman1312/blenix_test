...
const WhoWeAre = () => {
    ...
    return (
        <section className="w-[95%] lg:w-[80%] mx-auto relative pb-10">
            <div className="bg-custom-orange h-[100px] w-[100px] lg:h-[50px] lg:w-[900px] z-[-1] filter_blur2 rounded-full absolute left-[15%] top-[70%]" />
            ...
            <div className="flex justify-between items-stretch mt-10 flex-wrap w-full">
                <div className="w-full md:w-[50%] lg:w-[24%] bg_glass rounded-[20px] p-5 flex flex-col items-center">
                    <h1 className="text-white text-2xl font-bold">100%</h1>
                    <p className="text-white text-lg">Decentralized</p>
                </div>
            </div>
        </section>
    )
